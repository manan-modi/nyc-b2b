...
export const StructuredData = ({ article, data, baseUrl = "https://nycb2b.com" }: StructuredDataProps) => {
  // If article is provided, use the existing blog article structure
  if (article) {
  ...
  // If data is provided, use it directly (for events or other structured data)
  if (data) {
    return (
      <Helmet>
        <script
